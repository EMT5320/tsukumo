...
> 状态：北极星已冻结；V0 TUI 世界观、默认角色、视觉参考与内容包边界已收束，执行由 Trellis 任务管理。本文是 tsukumo 项目的唯一事实来源。
> 日期：2026-07-11
> 合并来源：`archive/DESIGN-A.md`（付丧神叙事主线）+ `archive/DESIGN-B.md`（事件驱动内核路线）+ 2026-07-07 讨论共识 + **2026-07-08 愿景收束讨论** + **2026-07-11 V0 前端收束讨论（舞台优先/九十九工房/栞/PresentationPack）**
